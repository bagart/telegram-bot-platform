...
All three models live in `telegram-bot-management-lib/src/Models/`. Migrations in `telegram-bot-management-lib/database/migrations/`.
...
Located in `telegram-bot-management-lib/database/migrations/`:
